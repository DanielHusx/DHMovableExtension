#
#  Be sure to run `pod spec lint DHMovableExtension.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  make cell in UITableView/UICollectionView easy to be movable.
                   DESC

  spec.homepage     = "https://github.com/DanielHusx/DHMovableExtension"
  ...
  spec.source_files  = "DHMovableExtension", "DHMovableExtension/*.{h,m}"
